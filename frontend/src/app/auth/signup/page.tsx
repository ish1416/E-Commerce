  ...
  return (
    <div className={styles.page}>
      <div className={styles.left}>
        ...
        <div className={styles.brand}>SHOPSMART</div>
        <h1 className={styles.tagline}>Start<br />selling.</h1>
        <p className={styles.sub}>Create your account and launch your store in minutes.</p>
      </div>
      ...
      <div className={styles.right}>
        <div className={styles.formBox}>
          <div className={styles.formHeader}>
            ...
            <p>Already have one? <Link href="/auth/signin" className={styles.link}>Sign in</Link></p>
          </div>
